/**
 File name: bfs_gpu_multi_more.cu
 Author: Yuede Ji
 Last update: 11:00 10-03-2015
...
#define N 65536 //1024 vertex number
//Using arrays to implement queue
#define N_block 32
#define Threads_limit 256 
...
int main()
{
    ...
    bfs<<<N_block, imin(Threads_limit, (N+N_block-1)/N_block)>>>(dev_edge, dev_dist);
